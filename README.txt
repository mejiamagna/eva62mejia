...
a persistence unit "eva62mejiaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62mejia/pom.xml":
...
artifact ("eva62mejia.war") is already built. You can build
